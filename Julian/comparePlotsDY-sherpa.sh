...
FILENAME1=DY_Sherpa_LO_Nov3
FILENAME2=DY_Sherpa_NLO_Nov3
FILENAME3=DY_Sherpa_NLOM_Nov3
#FILENAME4=P8_CP5_DIJET_AlphaS_0118_Gregory_mmdt_Sep8
#FILENAME5=P8_CR0_DIJET_AlphaS_0136
rivet-mkhtml -o rivet_plots_all/ZPJ_Nov3sherpa -c ../../Rivet/SMP/data/CMS_2018_PAS_SMP_18_QGX_ZPJ.plot \
...
yoda_files/$FILENAME2.yoda:'Title=Sherpa 2.2.10 NLO':'ErrorBars=1' \
