...
process.generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('QCDLO'),
  SherpackLocation = cms.string('/afs/desy.de/user/h/hinzmann/public/'),
  SherpackChecksum = cms.string('1c5b52add78d86d7e947b82108c6b04d'),
  ...
  SherpaParameters = cms.PSet(parameterSets = cms.vstring(
				...
				"}(processes)",
				" (selector){",
				" FastjetFinder antikt 2 25 0.0 Rjet;",
				"}(selector)",
				" (analysis){",
				" BEGIN_RIVET {",
				" -a PAPER_FIN_R8",
...
##  7.842e+10  7.842e+10  7.842e+10  7.842e+10  7.842e+10
        ...
        process.rivetAnalyzer.OutputFile = cms.string('QCD_Sherpa_LO_Nov26.yoda')
