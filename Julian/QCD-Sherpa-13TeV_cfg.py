...
process.generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('QCD'),
  SherpackLocation = cms.string('/afs/desy.de/user/h/hinzmann/public/'),
  SherpackChecksum = cms.string('1c03e30dc6bb931887dde2de12aada1c'),
  ...
  SherpaParameters = cms.PSet(parameterSets = cms.vstring(
				...
				" Enhance_Function VAR{PPerp2(p[2])} {2}",
				" Order (*,0);",
				" CKKW sqr(20/E_CMS)",
				" Integration_Error 0.01 {2};",
				" End process;",
				"}(processes)",
				" (selector){",
				" # Set cuts",
...
##  7.842e+10  7.842e+10  7.842e+10  7.842e+10  7.842e+10
        ...
        process.rivetAnalyzer.OutputFile = cms.string('QCD_Sherpa_Sep10.yoda')
