...
pythia8CP5SettingsBlock = cms.PSet(
    pythia8CP5Settings = cms.vstring(
        'Tune:pp 14', # CUETP8M1-NNPDF2.3LO ## Andreas:18 Robins:14
        'Tune:ee 7',
## Only for RobinsSetting(2)
        'MultipartonInteractions:pT0Ref=2.4024',
        'MultipartonInteractions:ecmPow=0.25208',
        'MultipartonInteractions:expPow=1.6',
        # these are to ensure the setup matches that used in 7_1_19
## Only for RobinsSetting2
        # 'PDF:pSet 13',
        # 'ColourReconnection:m0=0.5',
        # 'HadronScatter:rMax=0.5',
        # 'ResonanceWidths:minWidth=1.0000e-20',
        # 'SigmaTotal:sigmaEl=20.0',
        # 'SigmaTotal:sigmaTot=80.0',
        )
)
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
        ...
        PythiaParameters = cms.PSet(
                ...
                processParameters = cms.vstring(
                        'HardQCD:all = on',
## The next two values are different for RobinsSetting(2), but it shouldn't matter.
...
def customise(process):
	process.load('GeneratorInterface.RivetInterface.rivetAnalyzer_cfi')
        ...
        process.rivetAnalyzer.OutputFile = cms.string('FlatQCD_TuneCP5_CUETP8M1_RobinsSetting.yoda')
	process.rivetAnalyzer.CrossSection = cms.double(7.832e+09)
##  AndreasSetting  RobinsSetting  RobinsSetting2
##  7.832e+09       7.832e+09      7.832e+09
