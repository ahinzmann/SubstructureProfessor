...
./MakeSherpaLibs.sh -p DYLOM -o LBCR -v -m mpirun -M '-n 4'
...
./MakeSherpaLibs.sh -p QCDLOM -o LBCR -v -m mpirun -M '-n 4' 
...
mkdir /nfs/dust/cms/user/hinzmann/batch_yoda_files/DY_Sherpa_LOM_Mar16/ &
...
mkdir /nfs/dust/cms/user/hinzmann/batch_yoda_files/QCD_Sherpa_LOM_Mar16/ &
...
/afs/desy.de/user/h/hinzmann/grid-control/grid-control/go.py DY-Sherpa-LOM-13TeV.conf &
...
/afs/desy.de/user/h/hinzmann/grid-control/grid-control/go.py QCD-Sherpa-LOM-13TeV.conf &
...
yodamerge -o yoda_files/DY_Sherpa_LOM_Mar16.yoda /nfs/dust/cms/user/hinzmann/batch_yoda_files/DY_Sherpa_LOM_Mar16/job_* &
...
yodamerge -o yoda_files/QCD_Sherpa_LOM_Mar16.yoda /nfs/dust/cms/user/hinzmann/batch_yoda_files/QCD_Sherpa_LOM_Mar16/job_* &
