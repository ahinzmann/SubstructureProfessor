...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6-MinBias TuneZ2 at 13TeV'),
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/MinBias_TuneZ2_13TeV_pythia6_cff.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2_13TeV_pythia6_cff_py_GEN.root'),
...
pythia8CP5SettingsBlock = cms.PSet(
    pythia8CP5Settings = cms.vstring(
        ...
        'ColourReconnection:mode=1', # 0
        'ColourReconnection:range=5.176',
        'SigmaTotal:zeroAXB=off',
        'SpaceShower:alphaSorder=2',
        'SpaceShower:alphaSvalue=<__SpaceShower:alphaSvalue__>', # 0.118
        'SigmaProcess:alphaSvalue=0.118',
        'SigmaProcess:alphaSorder=2',
        'MultipartonInteractions:alphaSvalue=0.118',
        'MultipartonInteractions:alphaSorder=2',
        'TimeShower:alphaSorder=2',
        'TimeShower:alphaSvalue=<__TimeShower:alphaSvalue__>', # 0.118
